...
let handler = async (m, { conn, usedPrefix: _p }) => {
  try {
    ...
    //conn.sendHydrated(m.chat, text.trim(), conn.getName(conn.user.jid), await genProfile(conn, m), 'https://www.youtube.com/channel/UC-zSki3WCFIflpibC9PkPjQ', 'YouTube', null, null, [['Speedtest', _p + 'ping'], ['Owner', _p + 'owner']], m)
   ...
   conn.sendButton(m.chat, `*${wish()}, ${name} 👋*`, text.trim(), await genProfile(conn, m), [['Speedtest', _p + 'ping'], ['Owner', _p + 'owner']], false, { quoted: fkon, contextInfo: { externalAdReply: { showAdAttribution: true,
    mediaUrl: "https://Instagram.com/playshop.online.id",
    mediaType: "VIDEO",
    description: "https://Instagram.com/playshop.online.id", 
    title: 'bot-playshop',
    body: wm,
    thumbnail: thumb,
    sourceUrl: sgc
